{
  programs.plasma = {
    ...
    files = {
      ...
      "kdeglobals"."KFileDialog Settings"."Preview Width" = 329;
      ...
      "kwinrc"."TabBox"."LayoutName" = "present_windows";
      ...
      "kwinrulesrc"."c94e5639-cf10-448e-b974-456c14ffbe40"."noborder" = true;
