{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "khotkeys"."{7d3de48a-13eb-48fa-9c6c-e5926c4c2565}" = "Meta+Space";
    ...
    files = {
      ...
      "kcminputrc"."Mouse"."cursorTheme" = "LyraQ-cursors";
      ...
      "khotkeysrc"."Data_1_2"."Comment" = "Start Rofi";
      "khotkeysrc"."Data_1_2"."Enabled" = true;
      "khotkeysrc"."Data_1_2"."Name" = "Launch Rofi";
      "khotkeysrc"."Data_1_2"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_1_2Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_1_2Actions0"."CommandURL" = "rofi-launcher.sh";
      ...
      "khotkeysrc"."Data_1_2Triggers0"."Key" = "Meta+Space";
      "khotkeysrc"."Data_1_2Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_1_2Triggers0"."Uuid" = "{7d3de48a-13eb-48fa-9c6c-e5926c4c2565}";
      "khotkeysrc"."Data_1_3"."Comment" = "";
      "khotkeysrc"."Data_1_3"."Enabled" = true;
      "khotkeysrc"."Data_1_3"."Name" = "Warp Mouse to Active Window";
      "khotkeysrc"."Data_1_3"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_1_3Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_1_3Actions0"."CommandURL" = "xdotool getwindowfocus mousemove --window %1 0 -20";
      "khotkeysrc"."Data_1_3Actions0"."Type" = "COMMAND_URL";
      "khotkeysrc"."Data_1_3Conditions"."Comment" = "";
      "khotkeysrc"."Data_1_3Conditions"."ConditionsCount" = 0;
      "khotkeysrc"."Data_1_3Triggers"."Comment" = "Simple_action";
      "khotkeysrc"."Data_1_3Triggers"."TriggersCount" = 1;
      "khotkeysrc"."Data_1_3Triggers0"."Key" = "Meta+W";
      "khotkeysrc"."Data_1_3Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_1_3Triggers0"."Uuid" = "{585d1fb6-8722-4a31-871f-f8e1b49cd678}";
      ...
      "kwinrc"."NightColor"."LatitudeAuto" = 33.4475;
      "kwinrc"."NightColor"."LongitudeAuto" = "-112.0866";
      ...
      "kwinrulesrc"."2b05893d-9bc4-47d0-ac12-5817eacd5bb7"."Description" = "Signal";
      "kwinrulesrc"."2b05893d-9bc4-47d0-ac12-5817eacd5bb7"."ignoregeometry" = true;
      "kwinrulesrc"."2b05893d-9bc4-47d0-ac12-5817eacd5bb7"."ignoregeometryrule" = 2;
      "kwinrulesrc"."2b05893d-9bc4-47d0-ac12-5817eacd5bb7"."position" = "800,874";
      "kwinrulesrc"."2b05893d-9bc4-47d0-ac12-5817eacd5bb7"."positionrule" = 3;
      "kwinrulesrc"."2b05893d-9bc4-47d0-ac12-5817eacd5bb7"."size" = "890,990";
      "kwinrulesrc"."2b05893d-9bc4-47d0-ac12-5817eacd5bb7"."sizerule" = 3;
      "kwinrulesrc"."2b05893d-9bc4-47d0-ac12-5817eacd5bb7"."wmclass" = "signal";
      "kwinrulesrc"."2b05893d-9bc4-47d0-ac12-5817eacd5bb7"."wmclassmatch" = 1;
      "kwinrulesrc"."7ebb5879-d84d-4a48-8d00-c070b9eac612"."Description" = "Telegram (Firefox)";
      "kwinrulesrc"."7ebb5879-d84d-4a48-8d00-c070b9eac612"."ignoregeometry" = true;
      "kwinrulesrc"."7ebb5879-d84d-4a48-8d00-c070b9eac612"."ignoregeometryrule" = 2;
      "kwinrulesrc"."7ebb5879-d84d-4a48-8d00-c070b9eac612"."position" = "1699,874";
      "kwinrulesrc"."7ebb5879-d84d-4a48-8d00-c070b9eac612"."positionrule" = 3;
      "kwinrulesrc"."7ebb5879-d84d-4a48-8d00-c070b9eac612"."size" = "846,990";
      "kwinrulesrc"."7ebb5879-d84d-4a48-8d00-c070b9eac612"."sizerule" = 3;
      "kwinrulesrc"."7ebb5879-d84d-4a48-8d00-c070b9eac612"."title" = "Telegram";
      "kwinrulesrc"."7ebb5879-d84d-4a48-8d00-c070b9eac612"."titlematch" = 2;
      "kwinrulesrc"."7ebb5879-d84d-4a48-8d00-c070b9eac612"."wmclass" = "firefox";
      "kwinrulesrc"."7ebb5879-d84d-4a48-8d00-c070b9eac612"."wmclassmatch" = 1;
      "kwinrulesrc"."9e5cfed7-cecd-4e9f-be34-0b5bb7cee438"."Description" = "Messages (Firefox)";
      "kwinrulesrc"."9e5cfed7-cecd-4e9f-be34-0b5bb7cee438"."ignoregeometry" = true;
      "kwinrulesrc"."9e5cfed7-cecd-4e9f-be34-0b5bb7cee438"."ignoregeometryrule" = 2;
      "kwinrulesrc"."9e5cfed7-cecd-4e9f-be34-0b5bb7cee438"."position" = "18,874";
      "kwinrulesrc"."9e5cfed7-cecd-4e9f-be34-0b5bb7cee438"."positionrule" = 3;
      "kwinrulesrc"."9e5cfed7-cecd-4e9f-be34-0b5bb7cee438"."size" = "775,990";
      "kwinrulesrc"."9e5cfed7-cecd-4e9f-be34-0b5bb7cee438"."sizerule" = 3;
      "kwinrulesrc"."9e5cfed7-cecd-4e9f-be34-0b5bb7cee438"."title" = "Messages for web";
      "kwinrulesrc"."9e5cfed7-cecd-4e9f-be34-0b5bb7cee438"."titlematch" = 2;
      "kwinrulesrc"."9e5cfed7-cecd-4e9f-be34-0b5bb7cee438"."wmclass" = "firefox";
      "kwinrulesrc"."9e5cfed7-cecd-4e9f-be34-0b5bb7cee438"."wmclassmatch" = 1;
