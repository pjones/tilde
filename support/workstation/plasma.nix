{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "khotkeys"."{585d1fb6-8722-4a31-871f-f8e1b49cd678}" = [ ];
      "khotkeys"."{79f4521c-ccc2-4870-9b39-b52f1369cf21}" = [ ];
      "khotkeys"."{7d3de48a-13eb-48fa-9c6c-e5926c4c2565}" = [ ];
      "khotkeys"."{b6d4e1cc-3289-44cd-a022-87941ef85c31}" = "F8";
      "khotkeys"."{e62c4fa6-d560-11ec-a0f7-5731faeb799a}" = [ ];
      ...
      "kwin"."Arrange Windows" = [ ];
      "kwin"."Clear Jump List" = [ ];
      ...
      "kwin"."Toggle Jump List" = [ ];
      "kwin"."Toggle Night Color" = [ ];
      "kwin"."Toggle Window Raise/Lower" = [ ];
      "kwin"."ToggleCurrentThumbnail" = [ ];
    ...
    files = {
      ...
      "kwinrc"."Effect-slide"."VerticalGap" = 10;
      ...
      "kwinrc"."NightColor"."LatitudeAuto" = 33.447500;
