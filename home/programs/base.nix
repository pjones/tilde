  ...
  config = lib.mkMerge [
    ...
    (lib.mkIf config.tilde.graphical.enable {
      home.packages =
        ...
        ++ lib.optionals config.tilde.graphical.design (
          with pkgs;
          [
        ...
        ++ lib.optionals config.tilde.graphical.ee (
          with pkgs;
          [
            kicad # Open Source Electronics Design Automation suite
          ]
        )
        ++ lib.optionals config.tilde.graphical.gis (
          with pkgs;
          [
        ...
        ++ lib.optionals config.tilde.graphical.photography (
          with pkgs;
          [
